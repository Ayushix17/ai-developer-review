...
💥 GitHub Landing Page Enhancements (DO THIS)

To make your repo look 🔥:

1. Add badges (top of README)
![Python](https://img.shields.io/badge/Python-3.9+-blue)
![AI Powered](https://img.shields.io/badge/AI-LLM-green)
...
## 📸 Screenshots
5. Pin this repo on your profile
🎯 Resume Impact Version (IMPORTANT)

Use this:

Built an AI-powered code review system that analyzes code for bugs, performance issues, and security vulnerabilities using LLMs, achieving structured feedback with scoring and actionable insights.
